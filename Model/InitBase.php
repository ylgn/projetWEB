	...
	function init($db_type,$db_name,$host,$username,$password){
		...
		try{
           ...
           //AJOUT FOREIGN KEY
            ...
            createEtudiant('AHDJOUDJ','Inès','ines.ahdjoudj@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('AIT ALI BRAHAM','Farouk','farouk.ait-ali-braham@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('AL WAZZAN','Zeina','zeina.al-wazzan@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('BAHLEL','Arslane','arslane.bahlel@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('BENDIB','Yakine','yakine.bendib@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('CHARLON','Cyril','cyril.charlon@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('AHDJOUDJ','Inès','ines.ahdjoudj@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('CHENNEBAULT','Théo','theo.chennebault@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('DANO','Théophile','theophile.dano@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('DESGRANGES','Henry-Julien','henry-julien.desgranges@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('FACQUET','Jérémie','jeremie.facquet@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('FIEVEZ','Romain','romain.fievez@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('KARIM','Douha','douha.karim@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('KOUDOSSOU MESSAN','Alison','alison.koudossou-messan@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('LACHI','Yamina','yamina.lachi@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('LEDOUX','Louis','louis.ledoux@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('MOORE','Tom','tom.moore@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('NADJEM','Nadir','nadir.nadjem@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('RASOARILALA','Juliette','juliette.rasoarilala@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('SAAL','Kenza','kenza.saal@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('SAKHO','Aïssatou','aissatou.sakho@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('SOK','Sam David','sam-david.sok@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('SPACI','Nikola','nikola.spaci@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
            createEtudiant('TANG','Eric','eric.tang@dauphine.eu','2000-01-01','15','15','15','15','inscit','blabla','oui');
		}catch(PDOException $e){}
        echo $e;
	}
