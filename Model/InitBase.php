	...
	function init($db_type,$db_name,$host,$username,$password){
		...
		try{
           ...
           //AJOUT FOREIGN KEY
            ...
            createEtudiant('AHDJOUDJ','Inès','ines.ahdjoudj@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete1.png');
            createEtudiant('AIT ALI BRAHAM','Farouk','farouk.ait-ali-braham@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete2.png');
            createEtudiant('AL WAZZAN','Zeina','zeina.al-wazzan@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete3.png');
            createEtudiant('BAHLEL','Arslane','arslane.bahlel@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete4.png');
            createEtudiant('BENDIB','Yakine','yakine.bendib@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete5.png');
            createEtudiant('CHARLON','Cyril','cyril.charlon@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete6.png');
            createEtudiant('AHDJOUDJ','Inès','ines.ahdjoudj@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete1.png');
            createEtudiant('CHENNEBAULT','Théo','theo.chennebault@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete2.png');
            createEtudiant('DANO','Théophile','theophile.dano@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete3.png');
            createEtudiant('DESGRANGES','Henry-Julien','henry-julien.desgranges@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete3.png');
            createEtudiant('FACQUET','Jérémie','jeremie.facquet@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete4.png');
            createEtudiant('FIEVEZ','Romain','romain.fievez@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete5.png');
            createEtudiant('KARIM','Douha','douha.karim@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete6.png');
            createEtudiant('KOUDOSSOU MESSAN','Alison','alison.koudossou-messan@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete1.png');
            createEtudiant('LACHI','Yamina','yamina.lachi@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete2.png');
            createEtudiant('LEDOUX','Louis','louis.ledoux@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete3.png');
            createEtudiant('MOORE','Tom','tom.moore@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete4.png');
            createEtudiant('NADJEM','Nadir','nadir.nadjem@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete5.png');
            createEtudiant('RASOARILALA','Juliette','juliette.rasoarilala@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete6.png');
            createEtudiant('SAAL','Kenza','kenza.saal@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete1.png');
            createEtudiant('SAKHO','Aïssatou','aissatou.sakho@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete2.png');
            createEtudiant('SOK','Sam David','sam-david.sok@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete3.png');
            createEtudiant('SPACI','Nikola','nikola.spaci@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete4.png');
            createEtudiant('TANG','Eric','eric.tang@dauphine.eu','2000-01-01','15','15','15','15','inscrit','blabla','oui','1','nom','site','../Vue/img/tete5.png');
		}catch(PDOException $e){}
        echo $e;
	}
